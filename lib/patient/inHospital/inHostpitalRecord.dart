...
void main() => runApp(MaterialApp(
  home: InhospitalRecord(),
));

class InhospitalRecord extends StatefulWidget {
  @override
  State createState() => new _InhospitalRecord();
}

class _InhospitalRecord extends State<InhospitalRecord> {
...
//    验证Form表单
    ...
    if (loginForm.validate() && IfTrue) {
      ...
      DioManager.getInstance().post('Hospital/HospitalMedicalRecords', formData,
              (data) {
            Widget okButton = FlatButton(
              child: Text("好的"),
              onPressed: () {
