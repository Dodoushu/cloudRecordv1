...
import 'outPatientMedical.dart';
import 'prescriptionRecord.dart';
import 'treatmentRecord.dart';
            ...
            children: [
              Container(padding: EdgeInsets.only(top: 30),
                child: new Row(
                  ...
                  children: [
                    buttonBuilder('门诊病历', Icons.book, (){
                      Navigator.push(context, MaterialPageRoute(builder: (context) => outpatientMedical()));
                    }),
                    buttonBuilder('处方记录', Icons.keyboard, (){
                      Navigator.push(context, MaterialPageRoute(builder: (context) => prescriptionRecord()));
                    }),
                    buttonBuilder('治疗记录', Icons.clear, (){
                      Navigator.push(context, MaterialPageRoute(builder: (context) => treatmentRecord()));
                    })
                  ],
                ),
              ),
