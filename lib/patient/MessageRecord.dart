...
class MessageRecord extends StatefulWidget {
  String uid;
  MessageRecord(String uid){
    this.uid = uid;
  }
  @override
  _MessageRecord createState() => new _MessageRecord(uid);
}

class _MessageRecord extends State<MessageRecord> {

  String uid;
  List MessageList = new List();

  _MessageRecord(String uid) {
    this.uid = uid;
  }
...
//  }
  void getMessageList() async {
    Map map = new Map();
    map['userId'] = uid;
    await DioManager.getInstance().post('/PatientSeeMessage', map, (data) {
            ...
            children: [
              new Row(
                ...
                children: [
                  ...
                  Text(
                    map['doctorRegisters'] == null ? 'null' : map['doctorRegisters'],
                    style: TextStyle(fontSize: 20),
                  ),
                ],
              ),
